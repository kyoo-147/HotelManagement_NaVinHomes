...
namespace HotelManagement.CTControls
{
    public partial class FormMessageBox : Form
    {
        ...
        private Color borderColor = Color.FromArgb(118, 185, 0);
        private Color primaryColor = Color.FromArgb(118, 185, 0);
        //Properties
        ...
        private void SetButtons(MessageBoxButtons buttons, MessageBoxDefaultButton defaultButton)
        {
            ...
            switch (buttons)
            {
                ...
                case MessageBoxButtons.YesNo:
                    ...
                    button2.BackColor = Color.FromArgb(84, 131, 53);
                ...
                case MessageBoxButtons.AbortRetryIgnore:
                    ...
                    button3.BackColor = Color.FromArgb(84, 131, 53);
        ...
        {
            var fbColor = new FormBoundsColors();
            fbColor.TopLeftColor = Color.FromArgb(128, 161, 32);
            fbColor.TopRightColor = Color.FromArgb(128, 161, 32);
            fbColor.BottomLeftColor = Color.FromArgb(128, 161, 32);
            fbColor.BottomRightColor = Color.FromArgb(128, 161, 32);
            return fbColor;
        }
        private FormBoundsColors GetSameDark()
        {
            var fbColor = new FormBoundsColors();
            fbColor.TopLeftColor = Color.FromArgb(118, 185, 0);
            fbColor.TopRightColor = Color.FromArgb(118, 185, 0);
            fbColor.BottomLeftColor = Color.FromArgb(118, 185, 0);
            fbColor.BottomRightColor = Color.FromArgb(118, 185, 0);
            return fbColor;
        }
        //Event Methods
