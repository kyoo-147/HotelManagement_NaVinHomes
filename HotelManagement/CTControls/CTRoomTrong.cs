...
namespace HotelManagement.CTControls
{
    public partial class CTRoomTrong : CTRoom
    {
        ...
        private Color borderColor = Color.FromArgb(150, 217, 87);
        ...
        public CTRoomTrong()
        {
            ...
            this.BackColor = Color.FromArgb(150, 217, 87);
        ...
        {
            touchMouse = true;
            setColorMove(Color.FromArgb(150, 217, 87), Color.FromArgb(150, 217, 87));
            this.Invalidate();
        }

        private void CTRoomTrong_MouseLeave(object sender, EventArgs e)
        {
            setColorLeave(Color.FromArgb(150, 217, 87), Color.FromArgb(150, 217, 87));
        }
