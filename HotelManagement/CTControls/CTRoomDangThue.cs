...
namespace HotelManagement.CTControls
{
    public partial class CTRoomDangThue : CTRoom
    {
        ...
        public CTRoomDangThue()
        {
            ...
            this.BackColor = Color.FromArgb(118, 185, 0);
        ...
        {
            setColorMove(Color.FromArgb(118, 185, 0), Color.FromArgb(118, 185, 0));
        }

        private void CTRoomDangThue_MouseLeave(object sender, EventArgs e)
        {
            setColorLeave(Color.FromArgb(118, 185, 0), Color.FromArgb(118, 185, 0));
        }
