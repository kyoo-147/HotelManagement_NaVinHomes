...
namespace HotelManagement.CTControls
{
    public partial class CTRoomDangSuaChua : CTRoom
    {
        ...
        private Color borderColor = Color.FromArgb(92, 159, 29);
        ...
        public CTRoomDangSuaChua()
        {
            ...
            this.BackColor = Color.FromArgb(92, 159, 29);
        ...
        {
            setColorLeave(Color.FromArgb(92, 159, 29), Color.FromArgb(92, 159, 29));
        }

        private void CTRoomDangSuaChua_MouseMove(object sender, MouseEventArgs e)
        {
            setColorMove(Color.FromArgb(92, 159, 29), Color.FromArgb(92, 159, 29));
        }
