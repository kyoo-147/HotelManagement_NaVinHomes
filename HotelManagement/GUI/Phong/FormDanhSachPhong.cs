        ...
        private void buttonExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    CTMessageBox.Show(mess, "Notification", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            catch (Exception)
            {
                ...
                if (x == 6)
                {
                    ...
                    if (dialogresult == DialogResult.Yes)
                    {
                        try
                        {
                            ...
                            {
                                CTMessageBox.Show("This room has already been booked, so it cannot be deleted!", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Error);
                                return;
                            }
