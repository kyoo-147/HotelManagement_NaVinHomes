...
namespace HotelManagement.GUI
{
    public partial class FormThemPhong : Form
    {
        ...
        private void CTButtonCapNhat_Click(object sender, EventArgs e)
        {
            ...
            {
                CTMessageBox.Show("Please enter complete room information.", "Notifications",
            ...
            try
            {
                ...
                {
                    CTMessageBox.Show("Room code has incorrect syntax\r\n Please enter the syntax P+ floor + room code eg: P100", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    flag1 = 1;
                    return;
                }
                int flag = 0;
                ...
                if (flag == 0)
                {
                    CTMessageBox.Show("The maximum number of floors in the hotel is only 5", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    flag1 = 1;
                     return;
                }
                ...
                if (phong!=null)
                {
                    ...
                    CTMessageBox.Show("This room already exists on the upper floor\r\n The maximum room in the floor is: " + Maph1, "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    flag1 = 1;
                    return;
                }
            ...
            finally
            {
                if (flag1 == 0)
                {
                    CTMessageBox.Show("Added information successfully.", "Notifications",
