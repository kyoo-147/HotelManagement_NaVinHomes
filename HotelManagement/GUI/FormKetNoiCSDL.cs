...
namespace HotelManagement.GUI
{
    public partial class FormKetNoiCSDL : Form
    {
        ...
        {
            // lay du lieu tu textbox ten server
            string server = textBoxServer.Texts;
            // lay du lieu tu textbox ten database
            ...
            {
                CTMessageBox.Show("Cannot be left blank! Please re-enter.", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            try
            {
                ...
                if (sqlHelper.isConnected)
                {
                    ...
                    CTMessageBox.Show("Database connection successful!", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Information);
            ...
            {
                CTMessageBox.Show("Error! An error occurred. Please try again later! Please check the information entered again.", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            #endregion
        }
        ...
        // Hàm sẽ hoạt đọng khi nút default được kích hoạt
        private void buttonDefault_Click(object sender, EventArgs e)
        {
            // Check db tren local, doc bang db mdf trong source
            #region Check DB Connection 
            // khoi tao chuoi ket noi database
            ...
            {
                CTMessageBox.Show("Error! An error occurred. Please try again later! Please restart the program.", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
            #endregion
        ...
        private void ctMinimize_Load(object sender, EventArgs e)
        {

        }

        private void ctClose_Load(object sender, EventArgs e)
        {
        ...
        private void textBoxDB__TextChanged(object sender, EventArgs e)
        {
        ...
        private void checkBoxLuu_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void textBoxServer__TextChanged(object sender, EventArgs e)
        {
