...
namespace HotelManagement.GUI
{
    public partial class FormDatLaiMatKhau : Form
    {
        ...
        private void ButtonOK_Click(object sender, EventArgs e)
        {
            ...
            {
                CTMessageBox.Show("Please enter password", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }        
            if(this.textBoxPassword.Texts!=this.textBoxPassConfirm.Texts)
            {
                CTMessageBox.Show("Please check your password again", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                ...
                try
                {
                    ...
                    CTMessageBox.Show("Password changed successfully", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Information);

                }
                catch (Exception ex)
                {
                    CTMessageBox.Show(ex.Message,"Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
