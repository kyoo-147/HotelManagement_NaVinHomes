        ...
        private void CTButtonCapNhat_Click(object sender, EventArgs e)
        {
            if (this.ctTextBoxName.Texts != "" && this.ctTextBoxQuocTich.Texts != "" && this.ctTextBoxCMND.Texts != "" && this.comboBoxGioiTinh.Texts != "  Giới tính")
            {
                ...
                foreach (KhachHang khachHang in khachHangs)
                {
                    ...
                    {
                        CTMessageBox.Show("This CCCD/Passport number already exists in the customer list! Please check the information again.", "Notifications",
                ...
                CTMessageBox.Show("Please enter complete customer information.", "Notification",
                                MessageBoxButtons.OK, MessageBoxIcon.Error);
        }
