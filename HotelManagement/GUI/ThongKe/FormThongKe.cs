...
namespace HotelManagement.GUI.ThongKe
{
    public partial class FormThongKe : Form
    {
        ...
        public FormThongKe(FormMain formMain)
        {
            ...
            Button7Ngay.Select();
            Button7Ngay.BackColor = Color.FromArgb(26, 26, 26);
        ...
        private void setButtonNormal()
        {
            ButtonTuyChon.BackColor
                ...
                = Button6Thang.BackColor = Color.FromArgb(26,26,26);
        ...
        private void ButtonTuyChon_Click(object sender, EventArgs e)
        {
            ...
            ButtonTuyChon.BackColor = Color.FromArgb(26, 26, 26);
        ...
        {
            setButtonNormal();
            ButtonHomNay.BackColor = Color.FromArgb(26, 26, 26);
        ...
        {
            setButtonNormal();
            Button30Ngay.BackColor = Color.FromArgb(26, 26, 26);
        ...
        private void LoadData()
        {
            ...
            {
                CTMessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK,MessageBoxIcon.Error);    
            }
        }

        private void chartDoanhThuThue_Click(object sender, EventArgs e)
        {

        }

        private void chartDichVu_Click(object sender, EventArgs e)
        {

        }

        private void ctPanel4_Load(object sender, EventArgs e)
        {
        ...
        private void ctPanel6_Load(object sender, EventArgs e)
        {

        }

        private void ctPanel7_Load(object sender, EventArgs e)
        {
