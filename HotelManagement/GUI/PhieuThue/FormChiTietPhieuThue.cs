            ...
            if (y >= 0 && x == 4)
            {
                ...
                if (dialogresult == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        {
                            CTMessageBox.Show("This reservation information cannot be canceled because it has been completed!!", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            return;
                        }    
                        else if (cTDP.TrangThai == "Đang thuê")
                        {
                            CTMessageBox.Show("This reservation cannot be canceled due to rental status!!", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                            return;
                        }
                        ...
                        this.LoadGrid();
                        CTMessageBox.Show("Information deleted successfully.", "Notifications",
