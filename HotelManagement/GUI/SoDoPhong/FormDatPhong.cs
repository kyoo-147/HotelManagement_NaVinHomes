    ...
    public partial class FormDatPhong : Form
    {
        ...
        private void gridPhongTrong_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (y >= 0 && x == 2)
            {
                try
                {
                    ...
                    {
                        CTMessageBox.Show("Invalid start time.", "Notifications",
                    ...
                    {
                        CTMessageBox.Show("The start time cannot be after the end time.", "Notifications", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }    
                }
                catch(Exception ex)
                {
        ...
        private void gridPhongDaChon_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (y >= 0 && x == 4)
            {
                ...
                DialogResult dialogresult = CTMessageBox.Show("Are you sure you want to delete?", "Notifications",
        ...
        private void CTButtonDatTruoc_Click(object sender, EventArgs e)
        {
            ...
            {
                CTMessageBox.Show("No booking information added yet", "Notifications",
            ...
            if (this.CTTextBoxNhapCCCD.Texts != "" && this.CTTextBoxNhapDiaChi.Texts != "" && this.CTTextBoxNhapHoTen.Texts != "" && this.ComboBoxGioiTinh.Texts != "  Giới tính")
            {
                ...
                {
                    CTMessageBox.Show("Please enter full CCCD/Passport number.", "Notifications",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                if (CTTextBoxNhapSDT.Texts.Length != 10)
                {
                    CTMessageBox.Show("Please enter full phone number.", "Notifications",
                                    MessageBoxButtons.OK, MessageBoxIcon.Information);
                    return;
                }
                try
                ...
                {
                    CTMessageBox.Show(ex.Message, "Notifications",
                                MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
                finally
                {
                    if (flag == 1)
                    CTMessageBox.Show("Booking successful.", "Notifications",
                                MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                }
            }
            ...
            {
                CTMessageBox.Show("Please enter complete customer information.", "Notifications",
                     MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void CTTextBoxNhapCCCD__TextChanged(object sender, EventArgs e)
        {
            ...
            if (caseForm == 0)
            {
                ...
                {
                    CTMessageBox.Show("This CCCD/Passport number already exists in the list.\r\nThe information will be automatically filled in.", "Notifications",
                                MessageBoxButtons.OK, MessageBoxIcon.Information);
                    CTTextBoxNhapSDT.RemovePlaceholder();
                    CTTextBoxNhapDiaChi.RemovePlaceholder();
                    CTTextBoxNhapHoTen.RemovePlaceholder();
