...
namespace HotelManagement.GUI
{
    public partial class FormThongTinPhong : Form
    {
        ...
        private void LoadPage()
        {
            ...
            {
                CTMessageBox.Show(ex.Message, "Notification", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        #endregion
        ...
        private void CTButtonNhanPhong_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    CTMessageBox.Show("Earlier check-in is not possible.", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                if (phong.TTDD == "Chưa dọn dẹp")
                {
                    CTMessageBox.Show("The room has not been cleaned yet.", "Notification", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
            ...
            {
                CTMessageBox.Show(ex.Message, "Error message", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        ...
        private void CTButtonDatPhongNay_Click(object sender, EventArgs e)
        {
            ...
            {
                CTMessageBox.Show(ex.Message, "Notification",
                            MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            finally 
            { 
        ...
        {
            DialogResult dialogresult = CTMessageBox.Show("Are you sure you want to pay for this room?", "Notification",
            ...
            if (dialogresult == DialogResult.Yes)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        CTMessageBox.Show("Payment success.", "Notification",
        ...
        private void PanelBackgroundTop_Paint(object sender, PaintEventArgs e)
        {
