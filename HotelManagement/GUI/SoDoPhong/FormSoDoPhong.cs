...
namespace HotelManagement.GUI
{
    public partial class FormSoDoPhong : Form
    {
        ...
        // form nay se duoc goi vao khi nut so do phong bat duoc su kien click
        public FormSoDoPhong(FormMain formMain,TaiKhoan taiKhoan)
        {
            InitializeComponent();
            // lay cac gia tri cua form main va tai khoan hien tai
        ...
        public void LoadLanDau()
        {
            ...
            try
            {
                ...
                // instance duoc thiet ke theo mau skeleton
                // tao ra the hien duy nhat cua lop tuong ung
                // dieu nay dam bao rang chi co mot phie nban duy naht duoc
                // giup co the truy cap vao cac phuong thuc va thuoc tinh cua lop 
                // tu bat ky noi nao trong ma 
                phongs = PhongBUS.Instance.GetAllPhong();
                LoadPhong(phongs);
            }
            catch(Exception ex)
        ...
        // phuong thuc duoc su dung de load cac thong tin cua so do phong va hien thi
...
/*            panelSoDoPhong.Dock = DockStyle.None;
        ...
        private void PanelLocPhong_Paint(object sender, PaintEventArgs e)
        {

        }

        private void LabelTrangThaiPhong_Click(object sender, EventArgs e)
        {

        }

        private void PanelRadioButtonTrangThaiPhong_Paint(object sender, PaintEventArgs e)
        {
