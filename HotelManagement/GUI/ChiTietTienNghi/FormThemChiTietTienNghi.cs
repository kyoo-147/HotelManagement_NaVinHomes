...
namespace HotelManagement.GUI
{
    public partial class FormThemChiTietTienNghi : Form
    {
        ...
        private void ButtonThem_Click(object sender, EventArgs e)
        {
            ...
            if (TenTN == "  Amenity name" || SL == "" || GhiChu == "")
            {
                CTMessageBox.Show("Please enter complete amenities information.", "Notifications",
        ...
        private void ctTextBoxGhiChu__TextChanged(object sender, EventArgs e)
        {
